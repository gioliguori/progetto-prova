    ...
    <q-card class="q-mt-sm no-shadow" bordered>
      <q-card-section class="text-h6 q-pb-none">
        <q-item>
          ...
          <q-item-section>
            <div class="text-h6">RIEPILOGO NOLEGGIO</div>
          </q-item-section>
        </q-item>
      </q-card-section>
              ...
              <q-item>
                ...
                <q-item-section>
                  <q-item-label class="text-h6 text-blue text-bold"
                    >1000</q-item-label
                  >
                  <q-item-label caption>BICILETTE TOTALI</q-item-label>
                </q-item-section>
              </q-item>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
              <q-item>
                ...
                <q-item-section>
                  ...
                  <q-item-label caption
                    >BICICLETTE ATTUALMENTE NOLEGGIATE</q-item-label
                  >
                </q-item-section>
              </q-item>
            </div>
              ...
              <q-item>
                ...
                <q-item-section>
                  <q-item-label class="text-h6 text-green-6 text-bold"
                    >300</q-item-label
                  >
                  <q-item-label caption>BICICLETTE IN ATTESA</q-item-label>
                </q-item-section>
              </q-item>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
              <q-item>
                ...
                <q-item-section>
                  <q-item-label class="text-h6 text-orange-8 text-bold"
                    >200</q-item-label
                  >
                  <q-item-label caption>BICICLETTE DISMESSE</q-item-label>
                </q-item-section>
              </q-item>
            </div>
          </div>
    ...
    <q-card class="q-mt-sm no-shadow" bordered>
      <q-card-section class="text-h6 q-pb-none">
        <q-item>
          <q-item-section>
            <q-item-label>
              <div class="text-h6">LISTA DEI PARTNER</div>
            </q-item-label>
          </q-item-section>
        </q-item>
      </q-card-section>
...
const sales_column = [
  ...
  {
    name: "Total",
    label: "Totale incasso dal partner",
    field: "total",
    sortable: true,
    align: "right",
    classes: "text-bold",
    ...
    return {
      ...
      pie_options: {
        ...
        legend: {
          bottom: 10,
          left: "center",
          data: ["Noleggiate", "In attesa", "Dismesse"],
        },
        series: [
          {
            name: "Resoconto",
