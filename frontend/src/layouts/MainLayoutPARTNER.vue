<template>
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        <q-item to="/Dashboard1" active-class="q-item-no-link-highlighting">
        ...
        <q-item to="/TreeTable_LISTABICISUE" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/TreeTable_INSERISCIBICI" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/TreeTable_MODIFICABICI" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
