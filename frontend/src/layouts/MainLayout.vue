  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item to="/TreeTable_LISTAPARTNER" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/TreeTable_LISTABICI" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
        ...
        <q-item to="/TreeTable_INSERISCIPARTNER" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
